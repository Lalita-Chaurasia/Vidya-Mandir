...
document.getElementById("contactForm").addEventListener("submit",function(e){
	 e.preventDefault();
	 fetch("https://vidya-mandir.onrender.com",{ method:"POST", headers:{"Content-Type":"application/json"},
...
// Login
 function login(){ fetch("http://localhost:8080/login",{ method:"POST", headers:{"Content-Type":"application/json"},
...
// Add Student
 function addStudent(){ fetch("http://localhost:8080/student",{ method:"POST", headers:{"Content-Type":"application/json"},
